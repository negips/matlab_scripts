...
snormals = importdata('surf_normals.34.N5');
...
%---------------------------------------- 
snormals = importdata('surf_normals.34.N6');
...
%---------------------------------------- 
snormals = importdata('surf_normals.34.N8');
...
%---------------------------------------- 
snormals = importdata('surf_normals.34.N9');
