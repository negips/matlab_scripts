...
%ax1 = subplot(1,2,1);
ax1=axes;
splot=surf(ax1,surf_x,surf_t/2/pi,surf_v,'EdgeColor', 'none', 'LineStyle', 'none', 'FaceColor', 'interp');
colorbar;
view(2)
...
%ax2=subplot(1,2,2);
ax3=axes;
gplot=surf(ax3,surf_x,surf_t/2/pi,surf_c,surf_c,'EdgeColor', 'none', 'LineStyle', 'none', 'FaceColor', 'interp'); hold on
set(ax3,'Color', 'none')
view(2)
colormap(ax3,'gray');
...
ax4=axes;
gplot2=surf(ax4,surf_x,surf_t/2/pi,surf_c,surf_c,'EdgeColor', 'none', 'LineStyle', 'none', 'FaceColor', 'interp'); hold on
view(2)
axis tight
lncol1 = 'blue';
lncol2 = 'red';
ln1 = line([0 1], [3.25 3.25], [2 2], 'LineStyle', '--', 'LineWidth', 1.0, 'Color', lncol1, 'Parent', ax4);
ln2 = line([0 1], [3.50 3.50], [2 2], 'LineStyle', '--', 'LineWidth', 1.0, 'Color', lncol2, 'Parent', ax4);
ln3 = line([0 1], [3.75 3.75], [2 2], 'LineStyle', '--', 'LineWidth', 1.0, 'Color', lncol1, 'Parent', ax4);
ln4 = line([0 1], [4.00 4.00], [2 2], 'LineStyle', '--', 'LineWidth', 1.0, 'Color', lncol2, 'Parent', ax4);
