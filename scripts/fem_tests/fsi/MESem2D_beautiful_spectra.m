function [mass nek_mass DXM1 DYM1 DXM1D DYM1D RXM1 RYM1 SXM1 SYM1 convx convy convall convxd convyd convalld convxd_new convyd_new convalld_new Cx_fld Cy_fld gradm1x gradm1y gradm1xd gradm1yd intpm1d wtsvecd nek_conv lpx lpy lpall nek_lp lpbc forc x_coeff y_coeff Dx Dy w2m1 xm1 ym1 JACM1 JACM1D xm1d ym1d] = MESem2D5(Nx,Ny,Nxd,Nyd,xc,yc,ifplot)
...
spec2nodal2d = kron(spectonodal,spectonodal);
nodal2spec2d = inv(spec2nodal2d);
...
ifdiv=0;
if ifdiv
  div = gradm1xd*Cx_fld(:) + gradm1yd*Cy_fld(:);
  div = reshape(div,Nxd+1,Nyd+1);
  figure(201) 
  surf(xm1d,ym1d,div, 'EdgeColor', 'none', 'FaceColor', 'interp'); hold on
end  
%%
