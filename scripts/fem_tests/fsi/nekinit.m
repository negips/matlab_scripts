...
for ii=1:nelv
     ...
     [mass nek_mass DXM1 DYM1 DXM1D DYM1D RXM1 RYM1 SXM1 SYM1 convx convy convall convxd convyd convalld gradm1xd intpm1d nek_conv lpx lpy lpall nek_lp lpbc forc x_coeff y_coeff Dx Dy w2m1 xm1 ym1 JACM1] = MESem2D4(Nx,Ny,Nxd,Nyd,El(ii).xc,El(ii).yc,ifplot);
...
clearvars mass nek_mass DXM1 DYM1 DXM1D DYM1D RXM1 RYM1 SXM1 SYM1 convx convy convall convxd convyd convalld gradm1xd nek_conv lpx lpy lpall nek_lp lpbc forc x_coeff y_coeff Dx Dy w2m1 xm1 ym1 JACM1

clearvars xpt ypt ee ii jj

save(['matrices_N' num2str(Nx) '.mat']);
%% SOLVE
