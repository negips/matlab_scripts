...
FaultInitStress = repmat(0.55,FaultNglob,1);
...
FaultFriction.Dc  = 0.1;
FaultFriction.W = (FaultFriction.MUs-FaultFriction.MUd)./FaultFriction.Dc;
FaultStrength = friction(FaultState,FaultFriction) - FaultInitStress; % strength excess
...
% Central difference
% = Explicit Newmark scheme with alpha=1, beta=0, gamma=1/2
%
for it=1:NT,
