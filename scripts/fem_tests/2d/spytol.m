function spytol(S,arg2,arg3)
%SPY Visualize sparsity pattern.
%   SPYTOL(S) plots the sparsity pattern of the matrix S.
%
%   SPYTOL(S,'LineSpec') uses the color and marker from the line
%   specification string 'LineSpec' (See PLOT for possibilities).
%
%   SPYTOL(S,markersize) uses the specified marker size instead of
%   a size which depends upon the figure size and the matrix order.
%
%   SPYTOL(S,'LineSpec',markersize) sets both.
%
%   SPYTOL(S,markersize,'LineSpec') also works.

%   Copyright 1984-2011 The MathWorks, Inc. 
%   $Revision: 5.19.4.7 $  $Date: 2011/05/17 02:33:13 $
