...
NxNy_spec2nodal = kron(Nx_spec2nodal,Ny_spec2nodal);
NxNy_nodal2spec = kron(Nx_nodal2spec,Ny_nodal2spec);
...
dealias_truncatedspec2gll = kron(dealiased_intpx,dealiased_intpy);
