...
%[un_new, error, iter, flag] = gmres_tenn( stiff_n, un, b, [], 10, 10, 1.0e-6 );
...
%[una_new, error, iter, flag] = gmres_tenn( stiff_na, una, ba, [], 10, 10, 1.0e-6 );
