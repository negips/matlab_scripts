function [soln, glerr, t_iter, flag] = solve_strong( A,x0,b, max_it, tol, periodic)
...
%      Communication with neighboring elements
     ...
     [glx lx]=gllosolution(lx,periodic); 
...
function [gl_soln lo_soln] = gllosolution(lx,periodic)
