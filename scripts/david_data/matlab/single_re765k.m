...
for ii=1:ncases
  ...
  figure(1)
  plot(segments(iseg).qtime,segments(iseg).alpha*180/pi, 'Color', col1(ii,:))
  hold on;
  
  figure(2)
  plot(segments(iseg).ptime,segments(iseg).Cz, 'Color', col1(ii,:))
  hold on
  ...
  if ifshift
    ...
    plot(q_alpha*180/pi,q_cm, 'Color', col1(ii,:))
  end
  hold on
  ...
  if ifshift
    ...
    plot(q_alpha*180/pi,q_cz, 'Color', col1(ii,:))
  end
  hold on
