function [XC,YC,ZC,GL,LayerGEl,EF] = ExtrudeL2(mesh2d,LayerGEl,glno,il,nz0,Lz,ifcl,cz_pl,zf1,zf2);
...
%   Element types of neighbors
    ...
    elseif (strcmpi(etype,'e1') || strcmpi(etype,'e3'))
      ...
      dz = Lz/(2*nz);     % previous dz
      [XC1,YC1,ZC1,GL1,EF1]=BuildLayer2_E13(e,j,il,nz,dz,Lz,mesh2d,zf1,zf2);
      dz=2*dz;            % new dz
      cz_pl=0;
